// import components
import * as InternalStore from "@Components/controllers/index";
...
import { IApplicationState, reducers } from "@Components/controllers/index";
...
export default function configureStore(history: History, initialState?: IApplicationState) {
    ...
    if (module.hot) {
        module.hot.accept("@Components/controllers/index", () => {
            const nextRootReducer = require<typeof InternalStore>("@Components/controllers/index");
